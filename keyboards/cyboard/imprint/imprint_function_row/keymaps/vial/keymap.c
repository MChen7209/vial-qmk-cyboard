...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 LSFT_T(KC_ESC), LCTL_T(KC_A), LALT_T(KC_R), LGUI_T(KC_S), LSFT_T(KC_T), LT(4, KC_G),       KC_M,    RSFT_T(KC_N), RGUI_T(KC_E), RALT_T(KC_I), RCTL_T(KC_O), KC_QUOT,
    ...
    [3] = LAYOUT_fun(
        ...
        _______, _______, _______, _______, _______, _______,                           (9),    KC_NUM,  KC_PSLS, KC_PAST, KC_PMNS, KC_SCRL,
        _______, _______, _______, _______, _______, _______,                           LSFT(0),    KC_P7,   KC_P8,   KC_P9,   KC_PPLS, KC_PAUS,
        _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_PGUP,                           LSFT(KC_3), KC_P4,   KC_P5,   KC_P6,   KC_PCMM, KC_BSPC,
